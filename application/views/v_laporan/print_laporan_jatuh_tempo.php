...
<?php $tgl = $_GET['tgl'];
  ...
  if($jns_lap == 'excel'){
    ...
    header("Content-Disposition: attachment; filename=lap_jatuh_tempo_".$tgl.".xls"); 
    header("Expires: 0");
...
<table id="myTable" class="center">
    ...
    <tbody>
      ...
      foreach($get_barang as $row):
        $tgl_transaksi = date('d-m-Y H:i:s', strtotime($row -> tgl_act));
        ...
        <tr>
            ...
            <td style="text-align:center;"><?= $tgl_transaksi;?></td>
