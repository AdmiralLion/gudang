            ...
            <li class="nav-item dropdown active">
              <a href="#" data-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-store"></i><span>Transaksi</span></a>
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav-item active"><a href="#" class="nav-link">Retur Penjualan</a></li>
        ...
        <section class="section">
          ...
          <div class="section-body">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                <div class="col-md-4"><button id="tambah_returpenjualan" class="btn btn-icon icon-left btn-primary"><i class="fa fa-plus"></i> Tambah </button></div>
                </div>
                ...
                <div class="table-responsive">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          Tanggal Retur : <input class="form-control datepicker" type="text" name="tgl_transaksi" id="tgl_transaksi">
                        </div>
                        <div class="col-md-4"></div>
                      </div>
                      <table class="table table-striped" id="table-1">
                        <thead>                                 
                          <tr>
                            ...
                            <th class="text-center">User Retur</th>
                            <th class="text-center">Tgl Retur</th>
                            <th class="text-center">Print</th>
                          </tr>
                        </thead>
                        <tbody id="data_returpenjualan" style="text-align: center;">                                 
...
<div class="modal fade" id="modal_tambahreturpenjualan" role="dialog" aria-labelledby="modal_tambahreturpenjualan" aria-hidden="true">
                  <div class="modal-dialog" style="min-width:100%;" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="modal_tambahreturpenjualan">Retur Penjualan</h5>
                      ...
                      <div class="modal-body">
                        ...
                        <div class="col-md-4"></div>
                        <div class="col-md-4">
                          Tanggal Penjualan : <input class="form-control datepicker" type="text" name="tgl_retur" id="tgl_retur">
                        </div>
                        <div class="col-md-4"></div>
                      </div>
                      <table class="table table-striped" id="table-2">
                        ...
                        <tbody id="data_barangpenjualan" style="text-align: center;">                                 
                         
                        </tbody>
                      </table>

                      <br><br>
                      <table class="table table-striped" id="table-3" style="display:none;width:100%;">
                        <thead>                                 
                          <tr>
                            <th class="text-center" style="width:10px;">
                              No
                            ...
                            <th class="text-center">Kode Seri</th>
                            <th class="text-center">Pembeli</th>
                        ...
                        <tbody id="data_allbarang" style="text-align: center;width:100%;">                                 
